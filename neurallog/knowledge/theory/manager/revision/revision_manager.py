...
import neurallog.knowledge.manager.tree_manager as tm
import \
    neurallog.knowledge.theory.manager.revision.operator.revision_operator as ro
import neurallog.knowledge.theory.manager.revision.revision_examples as revision
import \
    neurallog.knowledge.theory.manager.revision.revision_operator_selector as rs
import neurallog.knowledge.theory.manager.theory_revision_manager as manager
...
class RevisionManager(Initializable):
    ...
    def __init__(self, theory_revision_manager=None, operator_selector=None):
        ...
        :type operator_selector: rs.RevisionOperatorSelector
        """
