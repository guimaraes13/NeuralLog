...
from neurallog.knowledge.theory.manager.revision.operator \
    .literal_appender_operator import LiteralAppendOperator
from neurallog.knowledge.theory.manager.revision.operator.revision_operator \
    import RevisionOperator
from neurallog.language.language import HornClause, Literal
