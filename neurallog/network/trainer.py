...
from neurallog.knowledge.program import get_predicate_from_string, BiDict, \
    NeuralLogProgram
from neurallog.language.language import Predicate
from neurallog.network.callbacks import EpochLogger, get_neural_log_callback, \
    AbstractNeuralLogCallback
from neurallog.network.dataset import get_dataset_class, NeuralLogDataset
from neurallog.network.network import LossMaskWrapper, NeuralLogNetwork
...
DEFAULT_INVERTED_RELATIONS = False
