...
from src.language.parser.autogenerated import NeuralLogParser
...
def get_file_source(context):
    """
    Gets the name of the file where the clause was founded.

    :param context: the clause context
    :type context: NeuralLogParser.ParserRuleContext
    :return: the file name
    :rtype: str
    """
    input_stream = None
    source = context.start.source
    if len(source) > 0 and isinstance(source[0], NeuralLogLexer):
        input_stream = source[0].inputStream
    elif len(source) > 1 and isinstance(source[1], FileStream):
        input_stream = source[1]
...
class TooManyArguments(Exception):
    ...
    def __init__(self, clause_provenance, found) -> None:
        """
        Creates a too many arguments exception.

        :param clause_provenance: the atom
        :type clause_provenance: ClauseProvenance
        ...
        super().__init__("Too many arguments found for {} at line {}:{}."
                         ...
                         .format(clause_provenance.text,
                                 clause_provenance.start_line,
                                 clause_provenance.start_column,
...
class ClauseProvenance:
    ...
    def __init__(self, context):
        ...
        self.start_line = context.start.line
        self.start_column = context.start.column
        self.filename = get_file_source(context)
...
class Clause:
    ...
    def set_provenance(self, context):
        ...
        :param context: the clause context
        :type context: NeuralLogParser.ParserRuleContext or ClauseProvenance
        """
        if context is not None:
            if isinstance(context, ClauseProvenance):
                self.provenance = context
            else:
                self.provenance = ClauseProvenance(context)
...
class Atom(Clause):
    ...
    def __init__(self, predicate, *args, weight=1.0, context=None) -> None:
        ...
        """
        super(Atom, self).__init__(context)
...
class AtomClause(Clause):
    ...
    def __init__(self, atom) -> None:
        ...
        """
        self.atom = atom
        super(AtomClause, self).__init__()
        self.provenance = atom.provenance
...
class HornClause(Clause):
    ...
    def __init__(self, head, *body, context=None) -> None:
        """
        ...
        :type body: Literal
        """
        super(HornClause, self).__init__(context)
        self.head = head
        self.body = list(body)
