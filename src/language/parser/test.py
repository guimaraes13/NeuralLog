...
def main(argv):
    ...
    x = np.zeros((1, len(neural_program.iterable_constants)))
    # x[0, neural_program.index_for_constant(Constant("pierro"))] = 1.0
    # x[0, neural_program.index_for_constant(Constant("andrew"))] = 1.0
    # x[0, neural_program.index_for_constant(Constant("roberto"))] = 1.0
    x[0, neural_program.index_for_constant(Constant("christopher"))] = 1.0
    ...
    print(prediction)
    for i in np.where(prediction != 0.0)[0]:
        print(prediction[i], neural_program.iterable_constants[i], sep=":\t")
